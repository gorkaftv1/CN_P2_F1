...
# CONFIGURACION
# ==========================================
# NOTA: Se elimino Dynamic Partitioning de Firehose por limite de 500 particiones activas.
# Ahora los datos se escriben sin particionar en raw/ y Glue se encarga del particionado.
$WAIT_AFTER_COMPLETION = 30  # Espera 30 segundos despues de que termine cada proceso
$MAX_WAIT_TIMEOUT = 600      # Timeout maximo (10 minutos) para cualquier operacion
...
# Kinesis
Write-Host "[2/10] Creando Kinesis Stream..." -ForegroundColor Green
...
# Lambda (comentada - no se necesita sin Dynamic Partitioning)
...
Write-Host "[3/11] Creando Firehose Delivery Stream..." -ForegroundColor Green

# Firehose (SIN Dynamic Partitioning - evita limite de 500 particiones activas)
$firehoseConfig = @{
    BucketARN = "arn:aws:s3:::$BUCKET_NAME"
    RoleARN = $ROLE_ARN
    Prefix = "raw/f1_driver_standings/"
...
Write-Host "[4/10] Creando Glue Database..." -ForegroundColor Green
# Glue Database
...
Write-Host "[5/10] Creando Glue Crawler..." -ForegroundColor Green
...
# Crawler para processed (AMBAS tablas)
$crawlerTargets = @{ 
    S3Targets = @(
...
Remove-Item crawler_targets.json
Write-Host "[6/10] Subiendo scripts ETL a S3..." -ForegroundColor Green
...
Write-Host "[7/10] Creando Glue Jobs..." -ForegroundColor Green
Set-Location $ScriptsDir
...
# ==========================================
# FASE DE EJECUCIÓN CON TIEMPOS DE ESPERA
# ==========================================

# Ejecutar productor Kinesis
Write-Host "\n[8/10] Ejecutando productor Kinesis..." -ForegroundColor Green
...
# Ejecutar Crawler RAW
Write-Host "\n[9/10] Ejecutando Crawler RAW..." -ForegroundColor Green
...
# ==========================================
# EJECUCIÓN DE JOBS SEGÚN SELECCIÓN
# ==========================================

Write-Host "\n[10/10] Ejecutando Glue Jobs..." -ForegroundColor Green
...
# ==========================================
# CRAWLER PROCESADO (ejecutar solo si hay jobs exitosos)
# ==========================================
